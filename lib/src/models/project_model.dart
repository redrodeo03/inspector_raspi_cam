class Child {
    ...
    Child({this.id, this.name, this.type,this.description,this.url,required this.count}); 
...
class Project {
    ...
    Project({this.id, this.name,this.projecttype, this.description, this.address,
     this.createdby,this.createdat, this.url, this.isavailableoffline, this.iscomplete,
      this.editedat, this.lasteditedby, this.assignedto, this.children}); 
...
class Projects {
    ...
    Map<String, dynamic> toJson() {
        final Map<String, dynamic> data = <String, dynamic>{};
        data['projects'] =projects != null ? projects!.map((v) => v?.toJson()).toList() : null;
