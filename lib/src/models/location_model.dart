...
class Section {
    ...
    Section({this.id, this.name, required this.visualsignsofleak,
    required this.furtherinvasivereviewrequired,this.visualreview,this.coverUrl,this.conditionalassessment,required this.count}); 
...
class Location {
    ...
    Location({this.id, this.name, this.description,this.parentid,this.parenttype,this.createdby,this.createdat, this.url, 
     this.editedat, this.lasteditedby,this.type,  this.sections}); 
