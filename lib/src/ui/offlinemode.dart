...
//     LocalProject newProject = LocalProject(realm.ObjectId(),
//         name: "",
//         description: "",
//         address: "",
//         url: "",
...
//             MaterialPageRoute(
//                 builder: (context) =>
//                     AddEditProjectPage(newProject, true, userFullName)))
//         .then((value) {
...
//               bottom: const TabBar(
//                 tabs: [
//                   Tab(text: 'My offline projects'),
//                   Tab(text: 'Available to download'),
//                   Tab(text: 'Downloaded projects'),
//                 ],
...
//                                     final projType = offlineProjects[index]
//                                                 ?.projecttype ==
//                                             null
//                                         ? "Multi-Level"
...
//                         );
//                       },
//                       future: projectsBloc.fetchAllProjects(),
//                     ),
//                   ),
//                 ],
//               ),
...
//                               itemBuilder: (context, index) {
//                                 //final projUrl = projects[index]?.url?.isEmpty?'assets/images/icon.png':projects[index]?.url;
//                                 final projType = projects[index]?.projecttype ==
//                                         null
//                                     ? "Multi-Level"
...
//   void gotoProjectDetails(BuildContext context, realm.ObjectId projectId) {
//     Navigator.push(
//         context,
//         MaterialPageRoute(
